...
function ciniki_puzzlelibrary_objects(&$ciniki) {
    ...
    $objects['item'] = array(
        ...
        'fields' => array(
            ...
            'owner_customer_id' => array('name'=>'Owner', 'ref'=>'ciniki.customers.customer', 'default'=>'0'),
            'current_customer_id' => array('name'=>'Current Holder', 'ref'=>'ciniki.customers.customer', 'default'=>'0'),
